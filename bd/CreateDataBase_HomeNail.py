...
try:
    ...
    def criaTabelaClientes():
        ...
        sql = 'CREATE TABLE t_clientes(id serial, nome varchar(100), cpf varchar(14), senha	varchar(50), telefone varchar(15), cep varchar(9), rua varchar(50), numero integer, cidade varchar(50), estado varchar(2), UNIQUE(id), CONSTRAINT pk_t_clientes PRIMARY KEY (id));'
    ...
    def criaTabelaFornecs():
        ...
        sql = 'CREATE TABLE t_fornecs(id serial, nome varchar(50), cpf varchar(14), senha varchar(50), telefone varchar(15), cidade varchar(50), estado varchar(2), UNIQUE(id), CONSTRAINT pk_t_fornecs PRIMARY KEY (id));'
